var swfobject = (function () {
        ...
        if (0 < a)
            for (var b = 0; b < a; b++) {
                ...
                if (0 < e.pv[0]) {
                    var d = p(c);
                    if (d)
                        if (!A(r[b].swfVersion) || (e.wk && 312 > e.wk))
                    ...
                    v(c, !0),
                        f &&
                            ((c = H(c)) &&
                                'undefined' != typeof c.SetVariable &&
                                ((g.success = !0), (g.ref = c)),
                            f(g));
            }
    }
    ...
    function F() {
        return !B && A('6.0.65') && (e.win || e.mac) && !(e.wk && 312 > e.wk);
    }
    function G(a, b, c, f) {
        B = !0;
        I = f || null;
        ...
        if (g) {
            ...
            f =
                'MMredirectURL\x3d' +
                n.location.toString().replace(/&/g, '%26') +
                '\x26MMplayerType\x3d' +
                f +
                '\x26MMdoctitle\x3d' +
                d.title;
    ...
    function K(a, b, c) {
        ...
        if (g)
            if (('undefined' == typeof a.id && (a.id = c), e.ie && e.win)) {
                var q = '',
                    h;
                for (h in a)
        ...
        if (!e.ie || !e.mac) {
            ...
            g &&
                ...
                (m && L == c) ||
                    ...
                    e.ie &&
                        e.win &&
                        'undefined' != typeof d.styleSheets &&
                        0 < d.styleSheets.length &&
                        (m = d.styleSheets[d.styleSheets.length - 1]),
                    (L = c)),
                e.ie && e.win
    ...
    (function () {
        e.w3 &&
            ((('undefined' != typeof d.readyState &&
                ...
                w(),
            u ||
                ('undefined' != typeof d.addEventListener &&
