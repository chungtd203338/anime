(function () {
    ...
    CKEDITOR.plugins.load('exportpdf', function () {
        function a(a) {
            var e = exportPdfUtils.getDefaultConfig(
                'unit',
                a.extraConfig || {},
            );
                        ...
                        function (b) {
                            ...
                            a.expectCss
                                ? assert.isNotUndefined(
                                      b.data.css,
                                      'Some CSS should be sent.',
                                  )
                                : assert.isUndefined(
                                      b.data.css,
                                      'No CSS should be sent.',
                                  );
                            assert.areEqual(
                                a.expectedHtml,
                                b.data.html,
        ...
        bender.test({
            ...
            'test no custom stylesheets attached to divarea editor':
                function () {
                    a({
                        creator: 'replace',
                        initialHtml:
            ...
            'test no custom stylesheets attached to inline editor':
                function () {
                    a({
                        creator: 'inline',
                        initialHtml:
            ...
            'test no custom stylesheets attached to classic editor':
                function () {
                    a({
                        creator: 'replace',
                        initialHtml:
