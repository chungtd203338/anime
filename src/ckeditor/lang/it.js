...
CKEDITOR.lang['it'] = {
    ...
    imagebase: { captionPlaceholder: "Inserire la didascalia dell'immagine" },
    easyimage: {
        commands: {
            fullImage: 'Immagine a dimensione intera',
            sideImage: 'Immagine laterale',
            altText: "Cambia testo alternativo dell'immagine",
            upload: 'Carica immagine',
        },
        uploadFailed:
            "L'immagine non può essere caricata a causa di un errore di rete.",
    },
};
