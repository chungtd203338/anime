...
CKEDITOR.lang['de-ch'] = {
    ...
    common: {
        ...
        invalidLength:
            'Wert spezifiziert für "%1" Feld muss ein positiver numerischer Wert sein mit oder ohne korrekter HTML-Masseinheit (px oder %).',
        invalidCssLength:
            'Wert spezifiziert für "%1" Feld muss ein positiver numerischer Wert sein mit oder ohne korrekter CSS-Masseinheit (px, %, in, cm, mm, em, ex, pt oder pc).',
        invalidHtmlLength:
            'Wert spezifiziert für "%1" Feld muss ein positiver numerischer Wert sein mit oder ohne korrekter HTML-Masseinheit (px oder %).',
        invalidInlineStyle:
    ...
    clipboard: {
        copy: 'Kopieren',
        copyError:
            'Die Sicherheitseinstellungen Ihres Browsers lassen es nicht zu, den Text automatisch zu kopieren. Bitte benutzen Sie die System-Zwischenablage über STRG-C (kopieren).',
        cut: 'Ausschneiden',
        cutError:
    ...
    indent: { indent: 'Einzug vergrössern', outdent: 'Einzug verkleinern' },
    smiley: {
    ...
    imagebase: { captionPlaceholder: 'Bildunterschrift eingeben' },
    easyimage: {
        commands: {
            fullImage: 'Bild in Originalgrösse',
            sideImage: 'Bild in Text',
            altText: 'Alternativ-Text des Bildes ändern',
            upload: 'Bild hochladen',
        },
        uploadFailed:
            'Aufgrund eines Netzwerkfehlers konnte Ihr Bild nicht hochgeladen werden.',
    },
};
