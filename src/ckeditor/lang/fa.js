...
CKEDITOR.lang['fa'] = {
    ...
    common: {
        ...
        unavailable:
            '%1<span class="cke_accessibility">، غیر قابل دسترس</span>',
        keyboard: {
            8: 'عقبگرد',
            13: 'ورود',
            16: 'تعویض',
    ...
    copyformatting: {
        label: 'کپی کردن قالب بندی',
        notification: {
            copied: 'قالب بندی کپی شد',
            applied: 'قالب بندی اعمال شد',
            canceled: 'قالب بندی لغو شد',
            failed: 'قالب بندی ناموفق بود. شما نمیتوانید بدون اینکه ابتدا سبک ها را کپی کنید ، آنها را اعمال نمایید',
        },
    },
    div: {
        IdInputLabel: 'شناسه',
    ...
    pastetext: {
        ...
        pasteNotification:
            '1% را فشاردهید تا بچسبد. مرورگر شما از چسباندن با دکمه نوارابزار یا گزینه منوی زمینه پشتیبانی نمیکند',
    ...
    imagebase: { captionPlaceholder: 'عنوان تصویر را وارد کنید' },
    easyimage: {
        commands: {
            fullImage: 'تصویر کامل',
            sideImage: 'تصویر جانبی',
            altText: 'تغییر متن جایگزین تصویر',
            upload: 'آپلود تصویر',
        },
        uploadFailed: 'به علت خطای شبکه، تصویر شما نمی‌تواند آپلود شود.',
    },
};
