...
CKEDITOR.lang['bg'] = {
    ...
    filetools: {
        ...
        httpError403:
            'Възникна HTTP грешка при качване на файла (403: Забранено).',
        httpError:
    ...
    liststyle: {
        ...
        validateStartNumber:
            'Началният номер на списъка трябва да е цяло число.',
    },
    ...
    table: {
        ...
        invalidCellSpacing:
            'Интервалът в клетките трябва да е положително число.',
    ...
    imagebase: { captionPlaceholder: 'Въведете надпис за изображението' },
    easyimage: {
        commands: {
            fullImage: 'Пълен размер изображение',
            sideImage: 'Странично изображение',
            altText: 'Променете алтернативния текст на изображение',
            upload: 'Качи изображение',
        },
        uploadFailed:
            'Изображението ви не можа да бъде качено поради грешка в мрежата.',
    },
};
