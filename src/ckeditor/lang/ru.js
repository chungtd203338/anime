...
CKEDITOR.lang['ru'] = {
    ...
    imagebase: { captionPlaceholder: 'Введите подпись к изображению' },
    easyimage: {
        commands: {
            fullImage: 'Изображение во всю ширину',
            sideImage: 'Изображение сбоку',
            altText: 'Изменить альтернативный текст',
            upload: 'Загрузить изображение',
        },
        uploadFailed:
            'Ваше изображение не может быть загружено из-за сетевой ошибки',
    },
};
