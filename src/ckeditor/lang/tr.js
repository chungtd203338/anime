...
CKEDITOR.lang['tr'] = {
    ...
    imagebase: { captionPlaceholder: 'Resim yazısını girin' },
    easyimage: {
        commands: {
            fullImage: 'Tam Boy Resim',
            sideImage: 'Yan Resim',
            altText: 'Resmin alt yazısını değiştir',
            upload: 'Resim Yükle',
        },
        uploadFailed: 'Ağ bağlantısı sorunu yüzünden resminiz yüklenemedi.',
    },
};
