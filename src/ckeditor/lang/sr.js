...
CKEDITOR.lang['sr'] = {
    ...
    copyformatting: {
        label: 'Копирање форматирања',
        notification: {
            copied: 'Копирано форматирање',
            applied: 'Форматирање примењено',
            canceled: 'Форматирање примењено',
            failed: 'Форматирање није успело. Не можете примењивати стилове пре него што их копирате.',
        },
    },
    div: {
        IdInputLabel: 'Ид',
    ...
    maximize: {
        maximize: 'Максимална величина',
        minimize: 'Минимлна величина',
    },
    ...
    pastefromword: {
        confirmCleanup:
            'Уметнути текст је копиран из Word-а.  Желите га очитити? ',
    ...
    table: {
        ...
        cell: {
            ...
            invalidColSpan:
                'У поље спој водоравно можете уписати само бројеве.',
            chooseColor: 'Изабери',
        },
    ...
    imagebase: { captionPlaceholder: 'Унесите опис слике' },
    easyimage: {
        commands: {
            fullImage: 'Слика у пуној величини',
            sideImage: 'Слика састране',
            altText: 'Измена алтернативниг текста',
            upload: 'Постављање фотографије',
        },
        uploadFailed: 'Слика се не може поставити због грешке у мрежи',
    },
};
