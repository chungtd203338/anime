...
CKEDITOR.lang['uk'] = {
    ...
    common: {
        ...
        confirmCancel:
            'Деякі опції змінено. Закрити вікно без збереження змін?',
        options: 'Опції',
        target: 'Ціль',
    ...
    image: {
        ...
        hSpace: 'Гориз. відступ',
        img2Button:
            'Бажаєте перетворити обране зображення на кнопку-зображення?',
    ...
    liststyle: {
        ...
        validateStartNumber:
            'Початковий номер списку повинен бути цілим числом.',
    },
    ...
    imagebase: { captionPlaceholder: 'Введіть підпис зображення' },
    easyimage: {
        commands: {
            fullImage: 'Зображення в повному розмірі',
            sideImage: 'Зображення збоку',
            altText: 'Змінити альтернативний текст зображення',
            upload: 'Завантажити зображення',
        },
        uploadFailed:
            'Ваше зображення не може бути завантажено через помилку мережі.',
    },
};
