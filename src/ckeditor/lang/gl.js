...
CKEDITOR.lang['gl'] = {
    ...
    copyformatting: {
        label: 'Copiar o formato',
        notification: {
            copied: 'Copiouse o formato',
            applied: 'Aplicouse o formato',
            canceled: 'Cancelouse o formatado',
            failed: 'Produciuse un erro ao formatar. Non é posíbel aplicar estilos sen copialos antes.',
        },
    },
    div: {
        IdInputLabel: 'ID',
    ...
    imagebase: { captionPlaceholder: 'Introducir o título da imaxe' },
    easyimage: {
        commands: {
            fullImage: 'Imaxe de tamaño completo',
            sideImage: 'Imaxe lateral',
            altText: 'Cambiar o texto alternativo da imaxe',
            upload: 'Enviar imaxe',
        },
        uploadFailed:
            'Non foi posíbel enviar a imaxe por mor dun erro da rede.',
    },
};
