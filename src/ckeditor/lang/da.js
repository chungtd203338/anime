...
CKEDITOR.lang['da'] = {
    ...
    notification: { closed: 'Notifikation lukket.' },
    toolbar: {
    ...
    pastetext: {
        ...
        pasteNotification:
            'Klik %1 for at indsætte. Din browser understøtter ikke indsæt med tastatur eller kontekstmenu-valg.',
    ...
    imagebase: { captionPlaceholder: 'Indtast billedtekst' },
    easyimage: {
        commands: {
            fullImage: 'Fuld billedstørrelse',
            sideImage: 'Sidebillede',
            altText: 'Skift billede alternativ-tekst',
            upload: 'Upload billede',
        },
        uploadFailed:
            'Dit billede kunne ikke uploades på grund af en netværksfejl.',
    },
};
