...
CKEDITOR.lang['et'] = {
    ...
    copyformatting: {
        label: 'Kopeeri vorming',
        notification: {
            copied: 'Vorming on kopeeritud',
            applied: 'Vorming on rakendatud',
            canceled: 'Vormindamisest loobuti',
            failed: 'Vormindamine nurjus. Stiile ei saa rakendada ilma neid enne kopeerimata.',
        },
    },
    div: {
        IdInputLabel: 'ID',
    ...
    imagebase: { captionPlaceholder: 'Sisesta pildi pealkiri' },
    easyimage: {
        commands: {
            fullImage: 'Täissuuruses pilt',
            sideImage: 'Pilt külje peal',
            altText: 'Pildi asendusteksti muutmine',
            upload: 'Laadi pilt üles',
        },
        uploadFailed: 'Pilti ei õnnestunud võrgu vea tõttu üles laadida.',
    },
};
