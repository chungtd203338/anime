...
CKEDITOR.lang['ku'] = {
    ...
    image: {
        ...
        button2Img:
            'تۆ دەتەوێت دوگمەی وێنەی دیاریکراو بگۆڕیت بۆ وێنەیەکی ئاسایی؟',
        hSpace: 'بۆشایی ئاسۆیی',
    ...
    selectall: { toolbar: 'هەموویی دیاریبکە' },
    ...
    imagebase: { captionPlaceholder: 'سەردێڕی وێنەکە بنوسە ' },
    easyimage: {
        commands: {
            fullImage: 'پڕ بە پڕی وێنەکە',
            sideImage: 'لای وێنەکە',
            altText: 'گۆڕینی جێگرەوەی تێکستی وێنەکە',
            upload: 'بارکردنی وێنە',
        },
        uploadFailed:
            'وێنەکەت ناتوانرێت بارکرێت بەهۆی هەڵەی پەیوەندیکردن بەتۆڕی نێت. ',
    },
};
