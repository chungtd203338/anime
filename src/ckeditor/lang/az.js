...
CKEDITOR.lang['az'] = {
    ...
    imagebase: { captionPlaceholder: 'Təsvir başlığını daxil edin' },
    easyimage: {
        commands: {
            fullImage: 'Tam Ölçülü Təsvir',
            sideImage: 'Kənar Təsvir',
            altText: 'Təsvirin alt-yazısını dəyiş',
            upload: 'Təsvir Yüklə',
        },
        uploadFailed: 'Təsvir şəbəkə xətası səbəbindən yüklənmədi.',
    },
};
