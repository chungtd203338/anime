...
CKEDITOR.lang['hr'] = {
    ...
    imagebase: { captionPlaceholder: 'Unesite naslov slike' },
    easyimage: {
        commands: {
            fullImage: 'Slika u punoj veličini',
            sideImage: 'Bočna slika',
            altText: 'Promijeni alternativni tekst slike',
            upload: 'Upload Image',
        },
        uploadFailed:
            'Vaša slika nije mogla biti poslana uslijed greške u mreži.',
    },
};
