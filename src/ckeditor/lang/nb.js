...
CKEDITOR.lang['nb'] = {
    ...
    filetools: {
        ...
        httpError403:
            'HTTP-feil oppsto under filopplasting (403: Ikke tillatt).',
    ...
    imagebase: { captionPlaceholder: 'Skriv inn bildetekst' },
    easyimage: {
        commands: {
            fullImage: 'Bilde i full bredde',
            sideImage: 'Sidebilde',
            altText: 'Endre alternativ tekst for bilde',
            upload: 'Last opp bilde',
        },
        uploadFailed:
            'Bildet ditt kunne ikke lastes opp på grunn av en nettverksfeil.',
    },
};
