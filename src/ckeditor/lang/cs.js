...
CKEDITOR.lang['cs'] = {
    ...
    copyformatting: {
        label: 'Kopírovat formátování',
        notification: {
            copied: 'Formátování zkopírováno',
            applied: 'Formátování použito',
            canceled: 'Formátování zrušeno',
            failed: 'Formátování selhalo. Nejdříve musíte styly zkopírovat, až pak je můžete použít.',
        },
    },
    div: {
        IdInputLabel: 'Id',
    ...
    imagebase: { captionPlaceholder: 'Zvolte popis obrázku' },
    easyimage: {
        commands: {
            fullImage: 'Obrázek v plné velikosti',
            sideImage: 'Postranní obrázek',
            altText: 'Změnit alternativní text obrázku',
            upload: 'Nahrát obrázek',
        },
        uploadFailed: 'Váš obrázek nemohl být nahrán',
    },
};
