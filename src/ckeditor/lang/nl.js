...
CKEDITOR.lang['nl'] = {
    ...
    imagebase: { captionPlaceholder: 'Geef een afbeelding bijschrift' },
    easyimage: {
        commands: {
            fullImage: 'Afbeelding op volledige grootte',
            sideImage: 'Side Image',
            altText: 'Change image alternative text',
            upload: 'Afbeelding uploaden',
        },
        uploadFailed:
            'De afbeelding kon niet worden opgeladen door een netwerkfout.',
    },
};
